...
type StorageUtilizationResult struct {
	...
	// Add more fields for additional EBS volumes as needed
}
...
// 	EBSVolume1Usage    float64 `json:"ebsVolume1Usage"`
// 	EBSVolume2Usage    float64 `json:"ebsVolume2Usage"`
// 	// Add more as needed based on your EBS setup
// }
...
// 	// Get EBS Volume 1 Usage
// 	ebsVolume1Usage, err := GetStorageMetricData(clientAuth, clusterName, namespace, startTime, endTime, "ebs_volume1_metric_name")
// 	if err != nil {
// 		log.Println("Error in getting EBS volume 1 usage: ", err)
// 		return "", nil, err
// 	}
...
// 	// Get EBS Volume 2 Usage
// 	ebsVolume2Usage, err := GetStorageMetricData(clientAuth, clusterName, namespace, startTime, endTime, "ebs_volume2_metric_name")
// 	if err != nil {
// 		log.Println("Error in getting EBS volume 2 usage: ", err)
// 		return "", nil, err
// 	}
...
// func GetStorageMetricData(clientAuth *model.Auth, clusterName, namespace string, startTime, endTime *time.Time, metricName string) (*cloudwatch.GetMetricDataOutput, error) {
// 	// Modify this function based on your specific EBS metric setup
// 	input := &cloudwatch.GetMetricDataInput{
// 		EndTime:   endTime,
// 		StartTime: startTime,
// 		MetricDataQueries: []*cloudwatch.MetricDataQuery{
...
// 					},
// 					Period: aws.Int64(300),
// 					Stat:   aws.String("Average"), // Choose appropriate statistic
// 				},
// 			},
// 		},
// 	}
