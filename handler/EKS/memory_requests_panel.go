...
func GetMemoryRequestData(cmd *cobra.Command, clientAuth *model.Auth) (string, map[string]*cloudwatch.GetMetricDataOutput, error) {
	...
	// Fetch raw data
	rawData, err := GetMemoryRequestMetricData(clientAuth, clusterName, namespace, startTime, endTime)
	if err != nil {
...
func GetMemoryRequestMetricData(clientAuth *model.Auth, clusterName, namespace string, startTime, endTime *time.Time) (*cloudwatch.GetMetricDataOutput, error) {
