...
func GetCPULimitsData(cmd *cobra.Command, clientAuth *model.Auth) (string, map[string]*cloudwatch.GetMetricDataOutput, error) {
	...
	// Fetch raw data
	rawData, err := GetCPULimitsMetricData(clientAuth, clusterName, namespace, startTime, endTime)
	if err != nil {
...
func GetCPULimitsMetricData(clientAuth *model.Auth, clusterName, namespace string, startTime, endTime *time.Time) (*cloudwatch.GetMetricDataOutput, error) {
