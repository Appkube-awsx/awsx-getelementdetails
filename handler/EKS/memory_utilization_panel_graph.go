...
func GetMemoryUtilizationGraphData(cmd *cobra.Command, clientAuth *model.Auth) (string, map[string]*cloudwatch.GetMetricDataOutput, error) {
	...
	rawData, err := GetMemoryUtilizationGraphMetricData(clientAuth, clusterName, namespace, startTime, endTime)
	if err != nil {
...
func GetMemoryUtilizationGraphMetricData(clientAuth *model.Auth, clusterName, namespace string, startTime, endTime *time.Time) (*cloudwatch.GetMetricDataOutput, error) {
