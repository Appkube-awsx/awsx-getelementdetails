...
func GetNetworkInPacketsPanel(cmd *cobra.Command, clientAuth *model.Auth) (string, map[string]*cloudwatch.GetMetricDataOutput, error) {
	...
	// Fetch raw data
	rawData, err := GetNetworkInPackerMetricData(clientAuth, instanceID, namespace, startTime, endTime)
	if err != nil {
...
func GetNetworkInPackerMetricData(clientAuth *model.Auth, instanceID string, namespace string, startTime, endTime *time.Time) (*cloudwatch.GetMetricDataOutput, error) {
