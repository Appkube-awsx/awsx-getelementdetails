...
func GetCPUReservationData(cmd *cobra.Command, clientAuth *model.Auth) (string, map[string]*cloudwatch.GetMetricDataOutput, error) {
	...
	// Fetch raw data
	rawData, err := GetCPUReservationMetricData(clientAuth, clusterName, namespace, startTime, endTime)
	if err != nil {
...
func GetCPUReservationMetricData(clientAuth *model.Auth, clusterName, namespace string, startTime, endTime *time.Time) (*cloudwatch.GetMetricDataOutput, error) {
